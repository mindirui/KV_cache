...
class Zero1to3StableDiffusionPipeline(DiffusionPipeline):
    ...
    def _encode_image(self, image, device, num_images_per_prompt, do_classifier_free_guidance):
        ...
        # import ipdb; ipdb.set_trace()   # todo debug clip_embeddings bf16, CLIP_projection.layer_norm.weight bf16, but get float32, and after visual_projection, get fp16 rather than bf16
        if do_classifier_free_guidance:
    ...
    def __call__(
        ...
        poses: Optional = None, # type: ignore
        ...
        prompt_img_mask: Optional[torch.FloatTensor] = None,
    ):
        r"""
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                unet_kwargs = {**(cross_attention_kwargs or {}), "timestep": t.item(), 't': i }
                noise_pred = self.unet(latent_model_input,
                                       t,
                                       encoder_hidden_states=prompt_embeds,
                                       pose=poses,
                                       cross_attention_kwargs=unet_kwargs,).sample
